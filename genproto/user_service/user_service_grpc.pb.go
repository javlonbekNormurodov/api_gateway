...
type UserServiceClient interface {
	...
	GetUserByID(ctx context.Context, in *GetUserByIDRequest, opts ...grpc.CallOption) (*GetUsersResponse, error)
...
func (c *userServiceClient) GetUserByID(ctx context.Context, in *GetUserByIDRequest, opts ...grpc.CallOption) (*GetUsersResponse, error) {
...
type UserServiceServer interface {
	...
	GetUserByID(context.Context, *GetUserByIDRequest) (*GetUsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUserByID(context.Context, *GetUserByIDRequest) (*GetUsersResponse, error) {
